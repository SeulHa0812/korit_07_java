...
/*
    가이드라인
    1. accountNum(계좌번호, 정수)
    2. accountHolder(예금주이름, 문자열)
    3. balance(잔액, 정수)
    4. pinNumber(비밀번호, 4자리 정수 0 ~ 9999

    2. 생성자
    기본 생성자
    계좌번호만 있는 생성자
    계좌번호, 예금주 있는 생성자
    계좌번호, 예금주, 초기 잔액 있는 생성자
    계좌번호, 예금주, 초기 잔액, 비밀번호 있는 생성자
...
//3. 메서드
    ...
    public void setBalance(int balance) {
        ...
        this.balance = balance; //초기 잔액 세팅이기 때문에 입금은 얘로 이루어질 수 x, 덮어쓰는게 됌
    }
...
//                    0000원이 출금되었습니다. 현재 잔액 : 0000원
    ...
    public void deposit(int amount, int inputPin) {
        ...
        balance += amount;
        System.out.println(amount + "원이 입금되었습니다. 현재 잔액 : " + balance + "입니다.");
    }
    ...
    public void withdraw(int amount, int inputPin) {
        ...
        if (balance - amount >= 0) {
            balance -= amount;
            System.out.println(amount + "원이 출금되었습니다. 현재 잔액은 : " + balance + "입니다.");
        } else {
