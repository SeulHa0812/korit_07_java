...
public class ProdcutMain {
    public static void main(String[] args) {
        ...
        //객체 생성 전에도 static 적용되어 있으면 불러올 수 있음
...
//        System.out.println(Product.getCount());
        ...
        System.out.println("정적 필드 조회 : " + Product.getCount()); // 정적 변수도 값이 바뀜
        ...
        System.out.println("일반 필드 조회 : " + product3.getInstanceCount()); //일반 필드 :1
        System.out.println("정적 필드 조회 : " + Product.getCount()); // 정적 필드 : 3
    }
}
