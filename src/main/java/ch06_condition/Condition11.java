...
//        }
        ...
        switch (selectedChar) {
            case "a":
                System.out.println("메뉴a을 선택하셨습니다.");
                break;
            case "b":
                System.out.println("메뉴b을 선택하셨습니다.");
                break;
            case "c":
                System.out.println("메뉴c을 선택하셨습니다.");
                break;
            case "d":
                System.out.println("메뉴d을 선택하셨습니다.");
                break;
            case "e":
                System.out.println("메뉴e을 선택하셨습니다.");
                break;
            case "f":
                System.out.println("메뉴f을 선택하셨습니다.");
                break;
            default:
                System.out.println("잘못 선택하셨습니다.");
        }
