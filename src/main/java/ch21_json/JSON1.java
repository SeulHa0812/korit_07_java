...
public class JSON1 {
    public static void main(String[] args) {
        JsonObject jsonObject1 = new JsonObject(); // 객체 생성
        ...
        System.out.println(jsonObject1); //result : {"username":1,"password":1234,"email":"a@test.com","name":"김일","score":4.5}
        // : , ""
        /*
            아까 배운 Map과의 차이가 있다면
            1. Map에서는 Key에 "" 없었고,
            JSON에서는 모든 key에 String 자료형처럼 보이도록 ""가 있음
            2. Map에서는 key1=value1의 형태
            JSON에서는 "key1":value1의 형태
         */
        ...
        /*
            ...
            그래서, 가독성을 개선하는 방법으로 출력하기도 함
            컴퓨터가 읽기 편한 방식이 안리ㅏ 사람이 읽기에 적합한 형태로 출력하는 것을
            pretty printing 이라는 표현을 씀
            이걸 외부에서 지원하는 방식을 수업함
         */
