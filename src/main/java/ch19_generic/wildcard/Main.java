...
//        animalData3.showData(); //error : car 객체는 Animal로 형변환이 안되기 때문에
        /*
            animalData3.showData(0에서 오류 발생
            AnimalData 클래스에서 정의도니 메서드 로직을 확인해보면
        ...
        /*
            .getAnimal(0을 정의하지 않았다고 가정한다면 현재 animalData4,5,6의
             필드에 어떤 클래스의 객체가 들어가있는지 모름.
